  ...
  const projects = [
    {
      ...
      title: "OSPDownloader",
      description:
        "APK Android para descargar videos de TikTok sin marca de agua. Gratis, privacidad primero y sin anuncios intrusivos.",
      technologies: ["Android", "React Native", "Expo"],
      demo: "https://ospdownloader.online",
      image: "/download.svg",
      showOnlyDemo: true,
    },
    {
      ...
      title: "CONNECT",
      description:
        "Proyecto en construcción. Mira los avances y arte del proyecto.",
      technologies: ["Diseño", "SVG", "UI"],
      progressUrl: "/connect/progress",
      ...
      <div className="max-w-7xl w-full">
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-3 sm:mb-4">
            Nuestros <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-gray-600">Proyectos</span>
          </h2>
                ...
                <div className="flex items-center gap-2 text-gray-700 group-hover:text-black transition-colors">
                  {project.progressUrl ? (
                    <>
                      ...
                      <span className="text-sm font-semibold">Ver Progreso</span>
                    </>
